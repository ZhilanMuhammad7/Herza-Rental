...
<section class="hero-wrap hero-wrap-2 js-fullheight"
    style="background-image: url('{{ asset('ladingPage/images/bg_2.jpg') }}');"
        ...
        <script>
            ...
            window.addEventListener("beforeunload", function(e) {
                if (!paymentStarted) {
                    ...
                    const confirmationMessage = "Kamu belum menyelesaikan pembayaran. Yakin ingin meninggalkan halaman ini?";
                    e.preventDefault();
